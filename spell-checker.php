...
$arguments = [
    ...
    'dictionariesByFileName' => ['n', Configurator::MAP, 'file name pattern -> list of dictionaries', 'map'],
    'dictionariesByFileExtension' => ['x', Configurator::MAP, 'file extension -> list of dictionaries', 'map'],
    ...
    'checkDictionaryFiles' => ['', Configurator::FLAG, 'check configured dictionary files for unused words'],
    ...
    'irregularWords' => ['i', Configurator::VALUES, 'irregular words', 'words'],
        'Output:',
    'maxErrors' =>      ['', Configurator::VALUE, 'maximum number of error before check stops', 'number'],
    'short' =>          ['s', Configurator::FLAG, 'show only file and list of words'],
    'topWords' =>       ['t', Configurator::FLAG, 'show list of top misspelled words'],
...
$defaults = [
    ...
    'dictionaryDirectories' => ['build/spell-checker', 'vendor/spell-checker'],
    'maxErrors' => SpellChecker::DEFAULT_MAX_ERRORS,
    'irregularWords' => ['PHPUnit'],
    'ignoreUrls' => false,
    'ignoreEmails' => false,
    'heuristics' => ['all'],
];
